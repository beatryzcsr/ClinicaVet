...
export default function Sobre() {
    return (
        <div
            id="sobre"
            className="min-h-screen w-full bg-cover bg-center bg-no-repeat bg-[#D0FAE5]"
                ...
                <div className="relative mx-auto flex w-full max-w-[1500px] flex-col items-center justify-center px-4 pb-3 pt-8">
                    <div className="mb-6 mt-23 flex items-center justify-center">
                        <img
                            src={logoMedVet}
                            alt="Logo"
                            className="h-28 w-28 rounded-full border-[6px] border-[#d4af37] bg-[#B6DBD9] object-cover shadow-[0_0_0_3px_rgba(20,83,45,0.18)]"
                        />
                    </div>
                    ...
                    <div className="flex w-full items-center justify-center gap-8 lg:gap-14">
                        ...
                        <div className="flex h-[340px] w-[550px] items-center justify-center rounded-[26px] border-[3px] border-[#d9d9d9] bg-[#00BC7D] shadow-[inset_0_0_0_1px_rgba(0,0,0,0.02)]">
